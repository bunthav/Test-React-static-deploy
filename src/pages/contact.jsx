                ...
                <div className="flex-w w-full p-b-42">
                  ...
                  <div className="size-212 p-t-2">
                    <span className="mtext-110 cl2">
                      Hello! My name is Ear bunthav. 
                    </span>
                    <p className="stext-115 cl6 size-213 p-t-18">
                      Welcome to my store. I am a student at the RUPP, majoring in Computer Science. I am currently working on a project to create an online shopping website using React.js and Node.js. This is my first project, and I hope you enjoy it.
                    </p>
                  </div>
                </div>
                <div className="flex-w w-full p-b-42">
